 ...
 * @param {Array<String>} options.allowedHeaders - Allowed headers.
 * @param {Boolean} options.credentials - Whether to allow credentials.
 * @param {Array<String>} options.exposedHeaders - Headers to expose to the client.
  ...
  cors(options = {}) {
    ...
    return (req, res, next) => {
      ...
      if (typeof origin === 'function') {
        ...
        isAllowed = origin.includes(requestOrigin);
        allowedOrigin = requestOrigin;
      } else {
        isAllowed = origin === '*' || origin === requestOrigin;
        allowedOrigin = origin === '*' ? '*' : requestOrigin;
      }
